...
static NSString *const AWSCognitoIdentityBootloader = @"Bootloader"; 
static NSString *const AWSCognitoIdentityBrand = @"DeviceBrand"; 
static NSString *const AWSCognitoIdentityDeviceFingerprint = @"DeviceFingerprint"; 
static NSString *const AWSCognitoIdentityHardware = @"DeviceHardware";
static NSString *const AWSCognitoIdentityManufacturer = @"DeviceManufacturer";  
...
static NSString *const AWSCognitoIdentityIsNetworkRoaming = @"IsNetworkRoaming"; 
...
static NSString *const AWSCognitoIdentitySimCountryIso = @"SimCountry"; 
static NSString *const AWSCognitoIdentitySimOperator = @"SimOperator"; 
...
+ (NSString *) userContextData: (int) minTarget build: (NSString *) build userPoolId: (NSString*) userPoolId username: (NSString *) username deviceId: (NSString * _Nullable) deviceId userPoolClientId: (NSString *) userPoolClientId {
    ...
    [AWSCognitoIdentityASF addIfNotNil: contextData key:AWSCognitoIdentityDeviceId value: ((deviceId == nil)? [device identifierForVendor].UUIDString : deviceId)]; 
