...
static NSString *const AWSInfoCognitoAuth = @"CognitoUserPool";  
NSString *const AWSCognitoAuthUserAccessToken = @"accessToken";  
static const NSString * AWSCognitoAuthUserIdToken = @"idToken";  
static const NSString * AWSCognitoAuthUserRefreshToken = @"refreshToken";  
static const NSString * AWSCognitoAuthUserScopes = @"scopes";
static const NSString * AWSCognitoAuthUserTokenExpiration = @"tokenExpiration";  
static NSString * AWSCognitoAuthUserPoolCurrentUser = @"currentUser";  
static NSString *const AWSCognitoAuthAppClientIdLegacy = @"CognitoUserPoolAppClientId";  
static NSString *const AWSCognitoAuthAppClientSecretLegacy = @"CognitoUserPoolAppClientSecret";  
static NSString *const AWSCognitoAuthAppClientId = @"AppClientId";  
static NSString *const AWSCognitoAuthAppClientSecret = @"AppClientSecret";  
...
- (instancetype)initWithConfiguration:(AWSCognitoAuthConfiguration *)authConfiguration; {
    if (self = [super init]) {
        ...
        _keychain = [AWSCognitoAuthUICKeyChainStore keyChainStoreWithService:[NSString stringWithFormat:@"%@.%@", [NSBundle mainBundle].bundleIdentifier, @"AWSCognitoIdentityUserPool"]];  
    }
    return self;
}
