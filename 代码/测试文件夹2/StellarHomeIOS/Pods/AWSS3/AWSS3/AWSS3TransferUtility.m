...
static NSTimeInterval const AWSS3TransferUtilityTimeoutIntervalForResource = 50 * 60; 
...
- (void)extractErrorInformation:(NSString *)responseString
    ...
    if ([responseString rangeOfString:@"<Error>"].location != NSNotFound) {
        ...
        xmlParser.wrapRootNode = YES; 
        xmlParser.nodeNameMode = AWSXMLDictionaryNodeNameModeNever; 
