...
#define BUILD_ARG_WRAPPER(type)                   RX_ARG_ ## type                                                     
...
#define UNDERSCORE_TYPE_CAT(_1, index, type)      RX_CAT2(_, type)                                                    
#define NAME_CAT(_1, index, type)                 SEPARATE_BY_UNDERSCORE(type, index)                                 
#define TYPE_AND_NAME_CAT(_1, index, type)        type SEPARATE_BY_UNDERSCORE(type, index)                            
...
+(void)initialize {
    ...
    defaultTypeID = CFGetTypeID((CFTypeRef)RXObjCRuntime.class); 
